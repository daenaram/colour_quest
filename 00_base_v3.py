...
class Play:
    ...
    def to_compare(self, user_choice):
        ...
        # retrieve user score, make it into a integer
        ...
        if current_round == how_many:
            ...
            # win / loss results and disable it
            self.next_button.config(state=DISABLED,
                                    text=status)
    ...
    def close_play(self):
        # reshow root (ie: choose rounds) amd end current
...
class DisplayHelp:
    def __init__(self, partner):
        ...
        help_text = "Your goal in this game is to beat the computer " \
                    ...
                    "rounds, it's your overall score that counts. \n\n" \
...
class DisplayStats:
    def __init__(self, partner, user_scores, computer_scores):
        ...
        self.help_text_label = Label(self.stats_frame, bg=stats_bg_colour,
        ...
        row_names = ["", "Total", "Best Score", "Worst Scores", "Average Score"]
